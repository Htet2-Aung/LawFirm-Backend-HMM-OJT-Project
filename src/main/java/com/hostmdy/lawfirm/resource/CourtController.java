...
public class CourtController {
	...
	@PostMapping("/update")
	public ResponseEntity<?> updateCourt(@Valid @RequestBody Court court,BindingResult result){
		...
		Court updateCourt = courtService.updateCourt(court);
		//Category createdCategory = categoryService.SaveOrUpdate(category, Number(id));
		
		
		return new ResponseEntity<Court>(updateCourt,HttpStatus.CREATED);
