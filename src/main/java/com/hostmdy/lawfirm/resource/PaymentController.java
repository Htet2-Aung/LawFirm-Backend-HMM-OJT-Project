...
public class PaymentController {
		...
		public PaymentController(PaymentService paymentService, MapValidationErrorService mapErrorService, ContractRepository contractRepository) {
			super();
		...
		public ResponseEntity<?> createPayment(@Valid @RequestBody Payment payment,BindingResult result,@PathVariable Long contractId){
			Contract contract = contractRepository.findById(contractId).get();
			contract.setPaymentStatus(CreateStatus.CREATED);
			...
			Payment createdPayment = paymentService.SaveOrUpdate(payment,contractId);
